      ...
      <nav className="sticky top-0 z-50 border-b border-gray-100 bg-white/95 backdrop-blur">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <Link to="/" className="flex items-center gap-3">
            ...
            <div
              className="flex h-11 w-11 items-center justify-center overflow-hidden rounded-xl bg-emerald-600 shadow-md"
            >
              <img
                src={bgimage}
                alt="FixmaTe Logo"
            ...
            <div>
              <h1 className="text-xl font-bold">
                Fix<span className="text-emerald-600">maTe</span>
              </h1>
        ...
        <div className="mx-auto grid min-h-[600px] max-w-7xl items-center gap-12 px-6 py-20 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-gray-600">
              FixmaTe connects you with trusted professionals
          ...
          <div className="relative">
              ...
              <img
  src={heroimage}
  alt="FixmaTe Home Service Professionals"
  className="relative z-10 w-full max-w-[560px] object-contain drop-shadow-xl rounded-4xl"
/>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 md:grid-cols-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex h-11 w-11 items-center justify-center overflow-hidden rounded-xl bg-emerald-600">
                <img
                  src={bgimage}
                  alt="FixmaTe Logo"
                  className="h-full w-full object-cover"
              ...
              <div>
                ...
                <h2 className="text-xl font-bold">
                  Fix<span className="text-emerald-400">
                    maTe
                  </span>
                </h2>
